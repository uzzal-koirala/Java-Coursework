...
<body>
                        ...
                        <tbody>
                            ...
                            %>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="openViewModal('<%= request.getContextPath() %>/gunaso/view?id=<%= g.getId() %>&popup=true')" class="btn-view" style="background: none; border: 1px solid var(--primary); color: var(--primary); padding: 6px 12px; border-radius: 6px; cursor: pointer;">
    ...
    <div class="modal-overlay" id="viewGunasoModal">
        <div class="modal-content-card" style="max-width: 800px; height: 80vh; display: flex; flex-direction: column;">
            <div class="modal-header">
                <h3 style="font-weight: 700;">Gunaso Details</h3>
    ...
    <script>
        ...
        window.onclick = function(event) {
            var addModal = document.getElementById('addGunasoModal');
